...
$sendto = $_POST['sendto']; 
if ($sendto == 'General Question'){
$sendto = 'beach@johnmax.ca';
}
if ($sendto == 'Technical Question'){
$sendto = 'info@primarytargetmedia.com';
}
...
$emailSuccessHandler->setSubject('Volleyball Registration Question');
