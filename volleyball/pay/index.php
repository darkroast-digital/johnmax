				...
				<div class="row">
					<div class="col-md-6">
							...
							<?php else : ?>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<div class="input-group">
											<span class="input-group-addon"><i class="fa"><?php echo strtoupper(currencyCode()); ?></i></span>
											<input readonly type="text" value="<?=@$_GET['payamount']?>" name="amount" class="form-control" placeholder="0.00" data-rule-required="true" data-rule-number="true">
										</div>
									</div>
								</div>	
								<?php if ( $config['show_description'] ) : ?>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea name="description" class="form-control h55 maxlength" maxlength="120" placeholder="Description" data-rule-required="true">John Max Sports & Wings</textarea>
										</div>
									</div>	
								<?php endif; ?>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" name="name" class="form-control" placeholder="Name" value="<?=@$_GET['name']?>"  data-rule-required="true">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3"><span class="colordanger">*</span>Email</label>
							<div class="col-md-9">
								<input type="text" name="email" class="form-control" placeholder="Email" value="<?php echo isset($invoice) && $invoice ? $invoice->email : @$_GET['eid'] ; ?>" data-rule-required="true" data-rule-email="true">
							</div>
						</div>
						<input type="hidden" name="teamid" value="<?=(isset($_GET['teamid'])? $_GET['teamid']: '')?>">
						<input type="hidden" name="playerid" value="<?=(isset($_GET['playerid'])? $_GET['playerid']: '')?>">
					...
					<div class="col-md-6">
							...
							<div class="form-group mb40">
								...
								<div class="col-md-9">
									<select name="country" class="form-control" data-rule-required="true">
										...
										<option value="<?php echo $country_code; ?>" <?php echo $country_code == 'CA' ? 'selected' : ''; ?>><?php echo $country_name; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
						...
						<div class="creditcard-content" style="display: none;">
