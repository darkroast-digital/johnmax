...
<title>John Max Sports &amp; Wings | Windsor, Ontario's Favourite Sports Bar</title>
<link rel="shortcut icon" type="image/x-icon" href="../images/favicon.ico" />
<link rel="stylesheet" type="text/css" href="../css/styles.css" />
<link rel="stylesheet" href="../masonry/public/css/app.css">
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-32684701-1']);
...
<div class="outside"><a name="top"></a>
  ...
  <!-- Begin Header -->
    ...
    <div id="header-inner">
      ...
      <!--Logo-->
      <div class="logo"><a href="./"><img src="../images/john-max-logo-2.png" alt="JOHN MAX Sports and Wings" /></a></div>
      <!--End Logo-->
      ...
      <div id="nav-wrap">
        <div id="nav-wrap-inner">
          ...
          <ul id="horz-nav-ul" class="sf-menu">
            ...
            <li class="volleyball"><a href="../volleyball.html">Beach Volleyball</a></li>
            <li class="gallery"><a href="../photo-gallery.php">Photos</a></li>
            <li class="jobs"><a href="#">Jobs</a>
            
            <ul><li><a href="../jobs-dougall.html">Dougall Location</a></li>
            <li><a href="../jobs-lauzon.html">Lauzon Parkway Location</a></li></ul>
...
<section class='example' id='grid-a'>
  ...
  <div id="footer">
    <div class="footer-inside clearfix">
      ...
      <!--Footers Left Column-->
     <div class="foot-left-col">Copyright &copy; 2014 John Max Sports &amp; Wings </div>
      <!--End Footers Left Column-->
      
      <!--Footers Right Column-->
      <div class="foot-right-col">
        <ul class="footer-menu">
            <li><a href="https://www.facebook.com/JohnMaxSportsandWings">Join us on Facebook</a></li>
...
<script type="text/javascript">Cufon.now();</script>
        <script src="../masonry/public/js//mason.js"></script>
                ...
                $("#grid-b").mason({
                    ...
                    layout: 'fluid'
                        ...
                        $("#toggle").on('click', function(event){
                            ...
                            $("#grid-b .filler").toggleClass('show')
                        })
                    }
                );
