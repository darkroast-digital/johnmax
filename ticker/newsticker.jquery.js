...
(function( $ ) {
    ...
    $.fn.newsticker.methods = {        
        ...
        getTwitterText: function( item, parseLinks ) {
            ...
            jQuery.each( item.entities, function(name, links) {                
                for ( var i = 0, max = links.length; i < max; i += 1 ) {
                    text = self.api( 'parseTwitterLink', text, links[i], name );        
                }
            });
        ...
        // Parse Twitter link
        parseTwitterLink: function( text, entity, type ) {
            ...
            if ( start < this.settings.excerptLength ) {
                url = this.api( 'getTwitterLink', entity, type );    
        ...
        getTwitterLink: function( entity, type ) {
            switch ( type ) {
                case 'urls' : 
    ...
    $.fn.newsticker.styles = {
        ...
        reveal : {    
            ...
            revealAll: function() {
                ...
                progress.span.text( progress.text );
